...
var MyVideoView = /** @class */ (function (_super) {
    ...
    MyVideoView.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: "my-video-container" },
            react_1.default.createElement("button", { className: "my-video-button-supp", onClick: this.props.onDelete }, "X"),
            react_1.default.createElement("button", { className: "my-video-button", onClick: function (event) { return _this.props.libraryItemOnClick(event, video); } }, video.title)));
    };
    return MyVideoView;
