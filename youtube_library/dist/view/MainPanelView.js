...
var MainPanelView = /** @class */ (function (_super) {
    ...
    MainPanelView.prototype.render = function () {
        var _a = this.props, showSearchForm = _a.showSearchForm, videoSelected = _a.videoSelected, onVideoAdd = _a.onVideoAdd;
        ...
        react_1.default.createElement("div", { className: "main-panel-search-view" },
            react_1.default.createElement(SearchFormView_1.default, { onVideoAdd: onVideoAdd }))) : (
        // Si la variable showSearchForm est à false, alors on affiche la vidéo sélectionnée par l'utilisateur
        react_1.default.createElement("div", { className: "main-panel-video" }, videoSelected && (
        // Si la variable videoSelected n'est pas null, alors on affiche la vidéo que l'utilisateur veut visionner en donnant l'id et le titre de la vidéo sélectionnée en props 
